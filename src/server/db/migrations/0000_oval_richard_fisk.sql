...
ALTER TABLE "budget_goals" ADD CONSTRAINT "budget_goals_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_transaction_tags_pk" ON "transaction_tags" USING btree ("transaction_id","tag_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_webhook_events_idempotency" ON "webhook_events" USING btree ("idempotency_key");